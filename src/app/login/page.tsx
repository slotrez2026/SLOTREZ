...
// ─────────────────────────────────────────────────────────────
// Slotrez — Login page (real Supabase auth + Google + 2FA)
...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    if (signInError) {
      // Wrong password vs email not found
        ...
        <div style={{ background: "#fff", border: "0.5px solid #e5e7eb", borderRadius: 12, padding: "2rem", width: "100%", maxWidth: 400 }}>
          ...
          <p style={{ textAlign: "center", fontSize: 12, color: "#6b7280" }}>
            ...
            {resendTimer > 0
              ...
              : <span style={{ color: "#2563eb", cursor: "pointer" }} onClick={handleResend}>Resend code</span>}
          </p>
          <p style={{ textAlign: "center", marginTop: ".5rem", fontSize: 12, color: "#2563eb", cursor: "pointer" }} onClick={() => setStep("credentials")}>
      ...
      <div style={{ background: "#fff", border: "0.5px solid #e5e7eb", borderRadius: 12, padding: "2rem", width: "100%", maxWidth: 400 }}>
        ...
        {notRegistered && (
          <div style={{ background: "#faeeda", border: "0.5px solid #f59e0b", borderRadius: 8, padding: "10px 12px", fontSize: 12, color: "#854f0b", marginBottom: "1rem", lineHeight: 1.6 }}>
            ...
            <Link href="/register" style={{ color: "#854f0b", fontWeight: 600, textDecoration: "underline" }}>
              Create an account
            </Link>{" "}or try a different email.
          </div>
        )}
